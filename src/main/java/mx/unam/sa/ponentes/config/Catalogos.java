...
private void alta_authorities() {
    ...
    private void cuestionario() {
        ...
        CatPregunta t1_catPregunta6 = new CatPregunta(null, "Ejes y líneas temáticas",
                "Seleccione la línea temática en que participa", catUna, tema1, true, 4);
        ...
        t1_catPregunta6.getCatContenido().add(new CatContenido(null, t1_catPregunta6,
                "Respo7sabilidad ética y compromiso social.",
                false, 7));
        ...
        t1_catPregunta6.getCatContenido().add(new CatContenido(null, t1_catPregunta6,
                "Ética9y Responsabilidad Social en la Dirección de Proyectos Cinematográficos: El Rol del Financiamiento Público",
                false, 9));
